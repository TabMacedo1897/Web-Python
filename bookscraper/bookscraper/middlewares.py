...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    #from crawler é somente para termos acesso aos settings quando iniciamos a função
    @classmethod
    def from_crawler(cls, crawler):
        return cls(crawler.settings)


    #Setando alguns dados para fazermos as requisições
    #Essas variaveis são pegas diredo do settings
    ...
    #Função para resolver os resultados
    ...
    #simpplesmente pega um user agent aleatório
    def _get_random_user_agent(self):
        random_index = randint(0, len(self.user_agents_list) - 1)
        return self.user_agents_list[random_index]

    #Verifica se esse user agent esta habilitado ou não
    ...
    #Função que o scrapy busca quando olha os middlewares
    def process_request(self, request, spider):        
...
#adiciona os dados de proxy direto no middleware
